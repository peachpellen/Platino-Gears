...
// in simulator we redefine to format for Gears Developer console
...
{\
	NSString * exceptionName = [@"org.gears." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gears";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGearsNativeItemNone = -1, 
	UIGearsNativeItemSpinner = -2,
	UIGearsNativeItemProgressBar = -3,
	
	UIGearsNativeItemSlider = -4,
	UIGearsNativeItemSwitch = -5,
	UIGearsNativeItemMultiButton = -6,
	UIGearsNativeItemSegmented = -7,
	
	UIGearsNativeItemTextView = -8,
	UIGearsNativeItemTextField = -9,
	UIGearsNativeItemSearchBar = -10,
	
	UIGearsNativeItemPicker = -11,
	UIGearsNativeItemDatePicker = -12,
	
	UIGearsNativeItemInfoLight = -13,
	UIGearsNativeItemInfoDark = -14,
	
	UIGearsNativeItemDisclosure = -15,
	
	UIGearsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Gears instances of
